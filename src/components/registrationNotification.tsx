...
export const RegistrationNotification = () => {
  ...
  return (
    <>
      {isVisible && (
        <div
          className="max-w-[940px] bg-background-second rounded-lg py-[32px] 
        ...
        >
          <div className="flex flex-col items-center relative px-[170px]">
            ...
            <p className="text-themetext font-bold text-[24px]">
              Congratulations! 🎉
            </p>
            <p className="text-themetext max-w-[560px] text-center text-[24px]">
              You have successfully submitted your application for the "Graphic
              Design" course.
            </p>
          </div>
        </div>
