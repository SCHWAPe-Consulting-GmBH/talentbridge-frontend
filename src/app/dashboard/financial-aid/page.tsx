          ...
          <div className="mt-[100px] flex flex-col items-center mb-16">
            ...
            <div className="bg-background-second rounded-full gap-3">
              <button
                ...
                className={`py-2 px-[45px] font-semibold border rounded-full ${activeTab === 'steps' ? 'bg-opacity-primary border-primary text-themetext' : 'border-transparent text-neutral2'}`}
              >
                Steps to Success
              </button>
              <button
                onClick={() => setActiveTab('hub')}
                className={`py-2 px-[45px] font-semibold border rounded-full ${activeTab === 'hub' ? 'bg-opacity-primary border-primary text-themetext' : 'border-transparent text-neutral2'}`}
              >
                Learning Hub
              </button>
            </div>
